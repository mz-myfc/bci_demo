...
/*
 * @description BCI: Package Length: 9 bytes - RR + AF
 * @author zl
 * @date 2024/9/6 15:44
 */
class BciRrAfProtocol {
  static final BciRrAfProtocol instance = BciRrAfProtocol();
  ...
  void parse(List<int> array) {
    ...
    var maxCount = _buffArray.length - 9; //Data Space
    while (i <= maxCount) {
      ...
      if (_buffArray[i] >= 128 &&
        ...
        int rr = _buffArray[i + 8];

        // Read Data
        Helper.h.readParseData(spo2, pr, pi, si, heart, wave, rr, af, battery);
