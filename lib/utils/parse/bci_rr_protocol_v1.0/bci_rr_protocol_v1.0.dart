...
/*
 * @description BCI: Package Length: 7 bytes - RR
 * @author zl
 * @date 2024/9/6 15:39
 */
class BciRrProtocol {
  static final BciRrProtocol instance = BciRrProtocol();
  ...
  void parse(List<int> array) {
    ...
    while (i <= maxCount) {
      ...
      if (_buffArray[i] >= 128 &&
        ...
        int rr = _buffArray[i + 6];

        // Read Data
        Helper.h.readParseData(spo2, pr, pi, si, heart, wave, rr, 0, battery);
